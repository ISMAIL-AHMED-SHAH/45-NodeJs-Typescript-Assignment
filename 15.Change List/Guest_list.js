var Guest_list = ['ismail', 'ahmed', 'shah'];
var absent_Guest = Guest_list[0];
console.log(absent_Guest, "is unable to join us");
Guest_list.splice(0, 1, "Syed");
Guest_list.forEach(function (guest) { return console.log("Dear ".concat(guest, " I am hosting a party on coming weekend.Looking forward to catching up and having a fantastic time together.")); });
